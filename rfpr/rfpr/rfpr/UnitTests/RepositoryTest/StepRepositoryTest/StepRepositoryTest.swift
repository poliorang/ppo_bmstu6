...
class StepRepositoryTests: XCTestCase {
    ...
    func testCreateStep() throws {
        let step = Step(id: "6442852b2b74d595cb4f4150", name: "Первый день", participant: nil, competition: nil)
    ...
    func testUpdateStep() throws {
        let previousStep = Step(id: "6442852b2b74d595cb4f4164", name: "Третий день", participant: nil, competition: nil)
        let newStep = Step(id: "6442852b2b74d595cb4f4164", name: "3 день", participant: nil, competition: nil)
    ...
    func testUpdateLootNilPrev() throws {
        let previousStep = Step(id: "6442852b2b74d595cb4f4740", name: "Пятый день", participant: nil, competition: nil)
        let newStep = Step(id: "6442852b2b74d595cb4f4740", name: "Третий день", participant: nil, competition: nil)
        var updatedStep: Step?
    ...
    func testDeleteStep() throws {
        let step = Step(id: "6442852b2b74d595cb4f4768", name: "Пятый день", participant: nil, competition: nil)
    ...
    func testDeleteStepNilLoot() throws {
        let step = Step(id: "6442852b2b74d595cb4f4740", name: "FFF", participant: nil, competition: nil)
    ...
    func testAddLoot() throws {
        ...
        let step = Step(id: "6442852b2b74d595cb4f4772", name: "A день", participant: nil, competition: nil)
    ...
    func testAddLootNil() throws {
        let loot = Loot(id: "6442852b2b74d595cb4f4784", fish: "Осетр", weight: 350, score: 850)
        let step = Step(id: "6442852b2b74d595cb4f4730", name: "Y день", participant: nil, competition: nil)
    ...
    func testDeleteLoot() throws {
        ...
        let step = Step(id: "6442852b2b74d595cb4f4780", name: "D день", participant: nil, competition: nil)
        
        XCTAssertNoThrow(try stepRepository.deleteLoot(loot: loot, step: step))
    }
    
    func testDeleteLootNil() throws {
        let step = Step(id: "6442852b2b74d595cb4f4710", name: "Y день", participant: nil, competition: nil)
